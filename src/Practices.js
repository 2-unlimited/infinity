...
function Practices() {
  const practices = [
    ...
    new Practice("DONT BLAME", "but give constructive feedback", "flaticon-people-1"),
    new Practice("TEST", "all the things", "flaticon-flasks"),
    new Practice("APPLY XP", "pairing, TDD, continuous everything", "flaticon-extreme-snowboard-silhouette"),
    new Practice("KNOWLEDGE SHARING", "is important", "flaticon-home-delivery-service"),
    new Practice("DO", "what you are afraid to do", "flaticon-people"),
    new Practice("FOLLOW UP", "on actions", "flaticon-compass-with-white-needles"),
